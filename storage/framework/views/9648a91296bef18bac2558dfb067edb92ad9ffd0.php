...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            <option value="active" <?php echo e((($post->status=='active')? 'selected' : '')); ?>>Bật</option>
            <option value="inactive" <?php echo e((($post->status=='inactive')? 'selected' : '')); ?>>Tắt</option>
        </select>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\fishshop\resources\views/backend/post/edit.blade.php ENDPATH**/ ?>